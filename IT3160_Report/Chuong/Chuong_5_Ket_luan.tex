...
\begin{enumerate}
    ...
    \item \textbf{Runtime Scenario System:} Admin có thể áp dụng ràng buộc vận hành (rain zone, đóng cửa ga, khoá đoạn segment) trong runtime mà không cần tắt dịch vụ, nhờ cơ chế invalidate cache theo chữ ký dữ liệu.
\end{enumerate}

Runtime demo hiện hành vận hành trên mạng dữ liệu đã đồng bộ với khoảng \textbf{124 ga khả dụng} của MRT Đài Bắc. Kết quả triển khai cho thấy hướng tiếp cận kết hợp GIS, A* search, walk access/egress, cache walk graph và admin scenario đáp ứng tốt phạm vi bài tập lớn: vừa giữ bài toán lõi là tìm đường metro, vừa tạo được trải nghiệm bản đồ trực quan và có khả năng xử lý tình huống vận hành.
