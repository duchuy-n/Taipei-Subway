...
\begin{itemize}
    ...
    \item \textbf{Frontend:} HTML, CSS, JavaScript thuần và MapLibre GL JS \cite{maplibre} cho hiển thị các lớp GeoJSON trên nền bản đồ OSM raster.
...
Hệ thống sử dụng vector chi phí cạnh $c(e) = (T, W, N_{tr}, N_{stop})$ để tìm đường tối ưu, trong đó:
\begin{itemize}
...
Người dùng cần cài đặt toàn bộ thư viện phụ thuộc, bao gồm FastAPI và các thư viện xử lý dữ liệu không gian, thông qua tệp \texttt{requirements.txt}:
\begin{tcolorbox}[
  enhanced,
