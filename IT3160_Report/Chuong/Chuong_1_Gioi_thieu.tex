...
\end{itemize}
Trong dữ liệu địa lý hiện tại, thời gian chạy tàu giữa hai ga liên tiếp được nội suy theo tốc độ \(80\,km/h\), còn tốc độ đi bộ mặc định là \(1.1\,m/s\). Walk-transfer nội bộ giữa các ga gần nhau vẫn bị phạt mạnh trong A* để hệ thống không lạm dụng đi bộ thay cho metro.
